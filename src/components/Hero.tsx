        ...
        <section className="relative overflow-hidden rounded-2xl md:h-[600px]  md:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 bg-linear-to-br from-rose-50 via-white to-pink-50 shadow-xl mt-8">
            ...
            <div className="relative max-w-7xl mx-auto h-full grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center">
                <div className="order-2 lg:order-1 z-10">
                    ...
                    <div className="mt-8 flex md:flex-wrap gap-4 w-full items-center">
                        <button
                ...
                <div className="relative md:flex justify-center items-center order-1 hidden lg:order-2 z-10">
