...
const testimonials: Testimonial[] = [
  {
    ...
    role: "Parent",
    quote:
      "Andrew was amazing. Been fighting for disability for years and got a deal done with back pay in a very timely manner.",
    rating: 5,
    featured: true,
  },
  {
    ...
    role: "Client",
    quote:
      "Andrew made the process of filing my claim with the VA extremely easy and he gave me the confidence that we would win and we successfully got my claim approved. We almost lost it but Andrew saved the day.",
    rating: 5,
    featured: true,
  },
  {
    ...
    role: "Book Lover",
    quote:
      "Andrew Robinson's tales offer family-friendly escape. Best stories I've read to my kids in years. Engaging without imposing ethics. Not preachy, just fun to read. We live without having to leave our kids with a screen.",
    rating: 5,
  },
  {
    name: "Sofia",
  ...
  },
  {
    ...
    role: "Parent",
    quote:
      "We a testament as a trial policy hub. We went to see if we could get the jury aid full of counseling from start to finish. WE fully strongly equal about the rule. We were very pleased with what our theme could aid all.",
    rating: 5,
  },
  {
    name: "Emma",
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold mb-2">
              What <span className="text-brand-light">readers</span> and{" "}
              <span className="text-brand-light">Families </span>
              <br /> Say About Us
            </h2>
          </motion.div>
          ...
          >
            {featuredReviews.map((testimonial) => (
              ...
              >
                {/* Quote Icon */}
                <div className="text-6xl text-brand-light mb-4 leading-none font-serif">
                  "
                </div>
