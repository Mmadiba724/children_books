...
export default function CarouselCard({
  ...
  return (
    <article className="group w-full bg-white shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer flex flex-col rounded-lg ">
      ...
      <div className="px-3 pb-4 mt-3">
        <button
          onClick={handleAddToCart}
          className="w-full bg-brand text-white font-semibold py-2.5 px-4 hover:bg-brand-dark transition-colors duration-200 text-sm"
        >
          Add to Cart
        </button>
      </div>
